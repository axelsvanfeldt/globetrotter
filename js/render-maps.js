/*
Script to render the maps used for the featues "Planned Trips" and "Places Visited".
    ...
    const maps = {
        initialize: () => {
            ...
            if (typeof map_data !== 'undefined') {
                maps.renderChart(am4core, am4maps, am4geodata_worldLow, am4themes_animated);
            }
        },
        getChartData: () => {          
        ...
        renderChart: (am4core, am4maps, am4geodata_worldLow, am4themes_animated) => {
            maps.getChartData();
